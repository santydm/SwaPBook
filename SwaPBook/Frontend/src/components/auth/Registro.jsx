...
const Registro = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:8000/estudiantes/registro', {
        nombre,
        correoInstitucional,
        contrasenia
      });
      ...
      setErrors({ submit: error.response?.data?.message || 'Error al registrar. Por favor intenta nuevamente.' });
    } finally {
      setIsLoading(false);
    }
  };
