...
const Registro = () => {
  ...
  const [correoInstitucional, setCorreoInstucional] = useState('');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:8000/estudiantes/registro', nuevoEstudiante);
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setCorreoInstucional(e.target.value)}
                    />
                  </div>
