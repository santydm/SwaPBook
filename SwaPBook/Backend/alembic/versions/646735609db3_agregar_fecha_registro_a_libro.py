...
Revision ID: 646735609db3
Revises: 05e2b73483ac
Create Date: 2025-06-03 19:14:46.840752
...
revision: str = '646735609db3'
down_revision: Union[str, None] = '05e2b73483ac'
...
def upgrade() -> None:
    ...
    op.add_column('libros', sa.Column('estado', sa.Enum('disponible', 'intercambio', name='estadolibroenum'), nullable=False))
