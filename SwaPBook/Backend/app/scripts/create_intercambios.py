...
if len(solicitudes_pendientes) < 80:
    ...
    estados_deseados = (
        ...
        [EstadoIntercambioEnum.en_proceso] * 15 +
        [EstadoIntercambioEnum.cancelado] * 15
    )
    ...
    for i in range(45):
        ...
        hora_encuentro = fake.date_time_between(start_date='-80d', end_date='+80d', tzinfo=timezone.utc).replace(minute=0, second=0, microsecond=0)
        ...
        intercambio = Intercambio(
            ...
            estado=estado,
            fechaCambioEstado = fake.date_time_between(start_date="-80d", end_date="+80d", tzinfo=timezone.utc)
